...
Section 1:
Research Question: Can happiness be related to whole countries?
...
| overall rank               | character | Rank (OR1 = Rank) 

| country or region      | character | Country (C1 = Country or R1= Region)  

| Social support      | character | Support (SS = Social Support)

| capita            | character | Capita (C1 = GDP per capita)

| life expectancy         | character | Health (LE1 = GDP Healthy life expectancy)
